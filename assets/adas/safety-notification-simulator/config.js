...
// type: 'scene' = full composite images (dashboard + windshield + tablet baked in)
// type: undefined/legacy = old layered approach (vehicle overlay + separate screen assets)
const SCENARIOS = [
    {
        id: 'bicycle',
        name: 'Bicycle',
